...
public class sortedMap extends mapDemo{
    ...
    public static void main(String[] args) {
        demonstrateMap("SortedMap");
        CollectionTypeInspector.printDefaultCapacitySummary("HashMap", "LinkedHashMap", "TreeMap", "Hashtable", "SortedMap");
    }
}
