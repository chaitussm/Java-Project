...
public class localeClass {
    ...
    public static void demonstrateStaticFactories() {
    ...
    public static void demonstrateGettersAndDisplay() {
    ...
    public static void demonstrateIsoAndLanguageTag() {
    ...
    public static void demonstrateExtensionsAndBuilder() {
    ...
    public static void demonstrateDefaultLocale() {
    ...
    public static void demonstrateAvailableAndIsoLists() {
    ...
    public static void demonstrateCloneEqualsHash() {
    ...
    public static void demonstrateFilterAndLookup() {
